...
class BeautyAnalyzerPro:
    ...
    def analyze(self, frame_bgr, static_image=False):
        ...
        lm = self._landmarks_to_pixels(result.multi_face_landmarks[0], w, h)
...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Beauty Detector Pro - PyQt5/OpenCV/MediaPipe")
    ...
    def update_result_ui(self, result):
        ...
        self.lbl_model.setText(f"{ml} ({mp:.3f})")
