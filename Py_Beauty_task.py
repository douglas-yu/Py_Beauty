...
class BeautyAnalyzerPro:
    ...
    def __init__(self):
        ...
        self.model_path = os.path.join(script_dir, "models", "face_landmarker.task")

        if not os.path.isfile(self.model_path):
            raise FileNotFoundError(
                f"Missing model file:\n{self.model_path}\n\n"
                "Create a 'models' folder next to this script and put 'face_landmarker.task' inside it."
            )
...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Beauty Detector Pro - PyQt5/OpenCV/MediaPipe Tasks")
    ...
    def _build_ui(self):
        ...
        for b in [self.btn_train, self.btn_load_model, self.btn_save_model, self.btn_reset_temporal]:
